...
/* Generated from ../O.Common/EMIL_PZI_00.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devEMIL_PZI_00Version, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devEMIL_PZI_00Version", "devLsoSoft", "devLsoSoftCallback",
...
int EMIL_PZI_00_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/emil/Apps/epics/R7.0.4.1/work/ioc/TEST/EMIL_PZI_00";
...
/* EMIL_PZI_00_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"EMIL_PZI_00_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(EMIL_PZI_00_registerRecordDeviceDriver(*iocshPpdbbase));
}
